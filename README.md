...
> Built by [Anderson Edmond](https://github.com/AndersonsRepo) as a personal AI infrastructure project. The system manages multiple production projects (including [Hey Lexxi](https://app.client-project.com)), handles academic tracking, monitors deployments, and evolves its own capabilities over time.
...
- **Hey-Lexxi** — Specialized for the Hey Lexxi production app
- **Mento** — Specialized for the Mento mentorship platform
- **LightRAG** — Knowledge graph RAG system expertise
- **Lattice** — Self-evolving generative art system
...
│   ├── agents/                # 9 agent personality files
...
│   │   ├── project-knowledge/ # Per-project context files
